                                        ...
                                        <div class="b-r">
                                            <a>
                                                <xsl:attribute name="href">
                                                    ...
                                                    <xsl:value-of select="../@sourcepath" />.html#
    ...
    <xsl:template name="display-bug">
        ...
        <div class="bb">
            <a>
                ...
                <xsl:attribute name="onclick">showbug('b-uid-<xsl:value-of select="@instanceHash" />
            ...
            <div style="display:none;">
                <xsl:attribute name="id">b-uid-<xsl:value-of select="@instanceHash" />-<xsl:value-of
                    select="@instanceOccurrenceNum" />-ph-
            ...
            <div class='ob-t'>
                <a>
                    ...
                    <span class='t-h'><xsl:value-of select="$category-count-p1" />/<xsl:value-of
                        select="$category-count-p2" />/<xsl:value-of select="$category-count-p3" />/
        ...
        <div class='ib-1'>
            <div class="ib-1-t">
                <a>
                    <xsl:attribute name="href"></xsl:attribute>
                    <xsl:attribute name="onclick">toggle('category-<xsl:value-of
                        select="$category" />-and-code-<xsl:value-of select="$code" />');return
                        false;
                    </xsl:attribute>
                    ...
                    <span class='t-h'><xsl:value-of select="$code-count-p1" />/<xsl:value-of
                        select="$code-count-p2" />/<xsl:value-of select="$code-count-p3" />/
            ...
            <div style="display:none;">
                <xsl:attribute name="id">category-<xsl:value-of select="$category" />-and-code-
                    <xsl:value-of select="$code" />
                </xsl:attribute>
        ...
        <div class='ib-2'>
            <div class='ib-2-t'>
                <a>
                    <xsl:attribute name="href"></xsl:attribute>
                    <xsl:attribute name="onclick">toggle('category-<xsl:value-of
                        select="$category" />-and-code-<xsl:value-of select="$code" />-and-bug-
                        <xsl:value-of select="$bug" />');return false;
                    </xsl:attribute>
                    ...
                    <span class='t-h'><xsl:value-of select="$bug-count-p1" />/<xsl:value-of
                        select="$bug-count-p2" />/<xsl:value-of select="$bug-count-p3" />/
            ...
            <div style="display:none;">
                <xsl:attribute name="id">category-<xsl:value-of select="$category" />-and-code-
                    <xsl:value-of select="$code" />-and-bug-
                    <xsl:value-of select="$bug" />
                </xsl:attribute>
                <xsl:variable name="cat-code-type">category-<xsl:value-of select="$category" />
                    -and-code-<xsl:value-of select="$code" />-and-bug-
                    <xsl:value-of select="$bug" />
                </xsl:variable>
                <xsl:variable name="bug-id">b-uid-<xsl:value-of select="@instanceHash" />-
                    <xsl:value-of select="@instanceOccurrenceNum" />
                </xsl:variable>
                <xsl:for-each
    ...
    <xsl:template name="packages">
        ...
        <div class='ob'>
            <div class='ob-t'>
                <a>
                    <xsl:attribute name="href"></xsl:attribute>
                    <xsl:attribute name="onclick">toggle('package-<xsl:value-of select="$package" />
                        ');return false;
                    </xsl:attribute>
                    <xsl:value-of select="$package" />
                    (<xsl:value-of
                    ...
                    <span class='t-h'><xsl:value-of select="$package-count-p1" />/<xsl:value-of
                        select="$package-count-p2" />/<xsl:value-of select="$package-count-p3" />/
        ...
        <div class='ib-1'>
            <div class="ib-1-t">
                <a>
                    <xsl:attribute name="href"></xsl:attribute>
                    <xsl:attribute name="onclick">toggle('package-<xsl:value-of select="$package" />
                        -and-class-<xsl:value-of select="$class" />');return false;
                    </xsl:attribute>
                    <xsl:value-of select="$class" />
                    (<xsl:value-of select="$class-count" />:
                    <span class='t-h'><xsl:value-of select="$class-count-p1" />/<xsl:value-of
                        select="$class-count-p2" />/<xsl:value-of select="$class-count-p3" />/
            ...
            <div style="display:none;">
                <xsl:attribute name="id">package-<xsl:value-of select="$package" />-and-class-
                    <xsl:value-of select="$class" />
                </xsl:attribute>
        ...
        <div class='ib-2'>
            <div class='ib-2-t'>
                <a>
                    <xsl:attribute name="href"></xsl:attribute>
                    <xsl:attribute name="onclick">toggle('package-<xsl:value-of select="$package" />
                        -and-class-<xsl:value-of select="$class" />-and-type-<xsl:value-of
            ...
            <div style="display:none;">
                <xsl:attribute name="id">package-<xsl:value-of select="$package" />-and-class-
                    <xsl:value-of select="$class" />-and-type-
                    <xsl:value-of select="$type" />
                </xsl:attribute>
                <xsl:variable name="package-class-type">package-<xsl:value-of select="$package" />
                    -and-class-<xsl:value-of select="$class" />-and-type-
                    <xsl:value-of select="$type" />
                </xsl:variable>
                <xsl:variable name="bug-id">b-uid-<xsl:value-of select="@instanceHash" />-
                    <xsl:value-of select="@instanceOccurrenceNum" />
