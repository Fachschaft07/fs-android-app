...
public class ExamFetcher {
	...
	private ExamFetcher(final Builder builder) {
		mCode = builder.mCode;
	 ...
	 *
	 */
	public static class Builder extends AbstractXmlFetcher<Builder, ExamFetcher> {
		...
		public Builder(final Context context) {
			super(context, FileUtils.createFile("exams.json"), URL, ROOT_NODE);
		}
		...
		public Builder addCodeFilter(final String code) {
			addFilter(new IFilter<ExamFetcher>() {
				@Override
				public boolean apply(final ExamFetcher data) {
		...
		@Override
		protected ExamFetcher onCreateItem(final String rootPath) throws Exception {
			// reset Variables...
			mGroup = null;
