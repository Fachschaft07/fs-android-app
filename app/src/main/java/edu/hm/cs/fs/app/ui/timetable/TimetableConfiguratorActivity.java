 ...
 */
public class TimetableConfiguratorActivity extends ActionBarActivity implements PageFragmentCallbacks, ReviewFragment.Callbacks, ModelCallbacks {
    ...
    private AbstractWizardModel mWizardModel = new TimetableConfiguratorModel(this);
