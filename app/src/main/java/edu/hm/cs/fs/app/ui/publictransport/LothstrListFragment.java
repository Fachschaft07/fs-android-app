...
@PerActivity
public class LothstrListFragment extends BaseFragment<LothstrListComponent, PublicTransportLothstrPresenter>
    ...
    @Override
    protected LothstrListComponent onCreateNonConfigurationComponent() {
        return DaggerLothstrListComponent.builder()
